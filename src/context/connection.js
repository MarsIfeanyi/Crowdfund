...
const Connection = createContext(); // Creating a context
...
export const useConnection = () => useContext(Connection); // Consuming the created context

export default ConnectionProvider; // This will be used as a wrapper in the App component
